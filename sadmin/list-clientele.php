...
<?php include("header.php"); ?>
	...
	<h1>Clientele</h1>
	<a href="add-edit-clientele.php" class="graybgbtn" style="float:left;margin-left: 10px;">Add New</a>
	</div>
	...
	<div class="rightbodysec">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="28%" align="left" valign="top"><form id="Clientele" name="Clientele" method="get">
			...
			?>
              <tr>
                <td colspan="6" align="left" valign="top" ><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
...
border: 1px solid #CCC;
    height: 28px;" />
            ...
            <?php 
				...
				$sqlQuery="";
				$sqlQuery="Select * from "._RESOURCES_TABLE_." WHERE pageType='clientele' ";
			...
			?><tr>
			    <td height="35" colspan="6" align="left" valign="top" style="padding:5px;">
				<div id="divdelete">
...
?>
						  <tr  <?php echo $strClass; ?>>
						    ...
						    <td align="left" valign="top"><?php echo $rowNews["resourceTitle"]; ?></td>
							<td align="left" valign="top"><?php //echo date("F d,  Y", $getDate); ?><?php echo date("Y/m/d",$rowNews["dateAdded"]); ?></td>
						    <td align="left" valign="top"><?php if ($rowNews["resourceFile"]!=''){ ?><img src="../uploads/<?php echo trim($rowNews['resourceFile']); ?>" height="100" width="100"><?php } ?> </td>
							...
							<tr>
							<td><a href="add-edit-clientele.php?editid=<?php echo $rowNews["resourceId"]; ?>"><img src="images/pencil.png" alt="Edit" width="16" height="16" title="Edit" border="0"></a></td>
							<td>&nbsp;</td>
			...
			?>
			  ...
			  <?php } ?>
			   <tr>
				...
				?>
              <tr>
                <td colspan="6" align="left" valign="top" style="padding:5px;">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<?php if($pageNo>1)
	{
		$prevPage=$pageNo-1;
	?>
		<a href="#"  onclick="javascript: document.Clientele.txtPageNo.value='<?php echo $prevPage; ?>';document.Clientele.submit();">&lt; previous</a>
	<?php
	}
	?>	</td>
	...
	<?php
		...
		for($pg=$page_min;$pg<= $page_max;$pg++)
		{
			if($pg==$pageNo)
				...
				$strPages.='<a href="#"  onclick="javascript: document.Clientele.txtPageNo.value='.$pg.';document.Clientele.submit();">'.$pg.'</a> | ';
		}
	...
	<?php if($pageNo>=1 && $pages>$pageNo)
	{
		$nextPage=$pageNo+1;
	?>
		<a href="#"  onclick="javascript: document.Clientele.txtPageNo.value='<?php echo $nextPage; ?>';document.Clientele.submit();">next &gt;</a>
	<?php
	}
	?>	</td>
  </tr>
