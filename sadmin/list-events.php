...
<?php include("header.php"); ?>
	...
	<h1>Events</h1>
	<a href="add-edit-events.php" class="graybgbtn" style="float:left;margin-left: 10px;">Add New</a>
	</div>
	...
	<div class="rightbodysec">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="28%" align="left" valign="top"><form id="Events" name="Events" method="get">
...
border: 1px solid #CCC;
    height: 28px;" />
            ...
            <?php 
				...
				$sqlQuery="";
				$sqlQuery="Select * from "._RESOURCES_TABLE_." WHERE pageType='events' ";
...
?>
						  <tr  <?php echo $strClass; ?>>
							...
							<td align="left" valign="top"><?php echo $rowNews["description"]; ?></td>
							...
							<tr>
							<td><a href="add-edit-events.php?editid=<?php echo $rowNews["resourceId"]; ?>"><img src="images/pencil.png" alt="Edit" width="16" height="16" title="Edit" border="0"></a></td>
							<td>&nbsp;</td>
  ...
  <tr>
	...
	<?php if($pageNo>1)
	{
		$prevPage=$pageNo-1;
	?>
		<a href="#"  onclick="javascript: document.Events.txtPageNo.value='<?php echo $prevPage; ?>';document.Events.submit();">&lt; previous</a>
	<?php
	}
	?>	</td>
	...
	<?php
		...
		for($pg=$page_min;$pg<= $page_max;$pg++)
		{
			if($pg==$pageNo)
				...
				$strPages.='<a href="#"  onclick="javascript: document.Events.txtPageNo.value='.$pg.';document.Events.submit();">'.$pg.'</a> | ';
		}
	...
	<?php if($pageNo>=1 && $pages>$pageNo)
	{
		$nextPage=$pageNo+1;
	?>
		<a href="#"  onclick="javascript: document.Events.txtPageNo.value='<?php echo $nextPage; ?>';document.Events.submit();">next &gt;</a>
	<?php
	}
	?>	</td>
  </tr>
