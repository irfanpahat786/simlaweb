		...
		{		
			...
			{						
				...
				$msgClass="red_error";
					...
					if(trim($_REQUEST["txtParam3"])!='' && is_file("../reports-publications/".$_REQUEST["txtParam3"]))
										unlink("../reports-publications/".$_REQUEST["txtParam3"]);
										
					if(trim($_REQUEST["txtParam4"])!='' && is_file("../reports-publications/".$_REQUEST["txtParam4"]))
										unlink("../reports-publications/".$_REQUEST["txtParam4"]);
			}
		}
...
<title>List Reports and Publications</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<a href="add-edit-reports-publications.php" class="graybgbtn" style="float:left;margin-left: 10px;">Add New</a>	</div>
...
border: 1px solid #CCC;
    height: 28px;" />
                    ...
                    <td align="left" valign="top" style="padding-left:10px;"><input name="Search" type="submit" id="Search" value="Search" class="graybgbtn btnLarge" />
                        <?php if(trim($_REQUEST["txtSearch"])!=''  || $_REQUEST["txtResourceType"]!=''  || $_REQUEST["homePageStatus"]!='') { ?>
            ...
            <?php 
				...
				$sqlQuery="";
				$sqlQuery="Select * from "._RESOURCES_TABLE_." WHERE pageType='"._REPORTS_PUBLICATIONS_VALUE_."' ";
			...
			?><tr>
			  ...
			  <tr>
			    ...
			    <td width="55%" height="35" align="left" valign="top" class="graysecheader" style="padding:5px;"> Title </td>
				<td width="8%" align="left" valign="top" class="graysecheader" style="padding:5px;"><strong>Posted Date</strong></td>
				<td width="8%" align="left" valign="top" class="graysecheader" style="padding:5px;"> URL</td>
				<td width="6%" align="left" valign="top" class="graysecheader" style="padding:5px;">File</td>
				<td width="5%" align="left" valign="top" class="graysecheader" style="padding:5px;">Status</td>
				<td width="14%" align="left" valign="top" class="graysecheader" style="padding:5px;">Action<span style="float:right; padding-right:5px;"><?php echo $totalRecords; ?> Items</span></td>
              </tr>
...
?>
						  <tr  <?php echo $strClass; ?>>
						    ...
						    <td align="left" valign="top" id="p<?php echo $rowNews["resourceId"]; ?>"><a href="<?php echo _VARDIR_._REPORTS_PUBLICATIONS_VALUE_.'/'.trim($rowNews['resourceUrl']).$dothtml;?>" target="_blank"><?php echo $rowNews["resourceTitle"]; ?></a></td>
							<td align="left" valign="top"><?php echo date("Y/m/d",strtotime($rowNews["resourceDate"])); ?></td>
						    <td align="left" valign="top">
							<div style="display:none;" id="clipboard<?php echo $rowNews["resourceId"]; ?>"><?php echo _VARDIR_._REPORTS_PUBLICATIONS_VALUE_.'/'.trim($rowNews['resourceUrl']).$dothtml;?></div>
							...
							<div id="removeddiv<?php echo $rowNews["resourceId"]; ?>">
                                ...
                                <a href="../reports-publications/<?php echo trim($rowNews['resourceFile']); ?>" target="_blank">
							...
							<tr>
							<td><a href="add-edit-reports-publications.php?editid=<?php echo $rowNews["resourceId"]; ?>"><img src="images/pencil.png" alt="Edit" width="16" height="16" title="Edit" border="0"></a></td>
							<td>&nbsp;</td>
...
function delok(resourceId,resourceFile)
{
	//var testfields=jQuery("#testfields").val();
		...
		jQuery.post("actions.php",{ actionRequired:"removedaction",resourceId:resourceId,resourceFile:resourceFile,rand:Math.random() } ,function(data)
		{
			//prompt("",data);
			console.log(data);
