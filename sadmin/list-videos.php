		...
		{		
			...
			{						
				...
				$msgClass="red_error";
					...
					if(trim($_REQUEST["txtParam3"])!='' && is_file("../uploads/".$_REQUEST["txtParam3"]))
										unlink("../uploads/".$_REQUEST["txtParam3"]);
...
<?php include("header.php"); ?>
	...
	<h1>Events</h1>
	<a href="add-edit-videos.php" class="graybgbtn" style="float:left;margin-left: 10px;">Add New</a>
	</div>
	...
	<div class="rightbodysec">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="28%" align="left" valign="top"><form id="Videos" name="Videos" method="get">
...
border: 1px solid #CCC;
    height: 28px;" />
            ...
            <?php 
				...
				$sqlQuery="";
				$sqlQuery="Select * from "._RESOURCES_TABLE_." WHERE pageType='videos' ";
				...
				$sqlQuery.="  order by resourceId DESC";
				
				//echo "<!-- ".$sqlQuery." -->";
				
				$resVideos=getRecords(_RESOURCES_TABLE_,$selectFields,$whereFields,$whereVals,_Y_,$sqlQuery);
		
				if($resVideos)
				{
					$totalRecords=mysql_num_rows($resVideos);
			...
			?><tr>
			  ...
			  <tr>
			    ...
			    <td width="25%" height="35" align="left" valign="top" class="graysecheader" style="padding:5px;"> Title </td>
				<td width="32%" align="left" valign="top" class="graysecheader" style="padding:5px;">&nbsp;</td>
				<td width="9%" align="left" valign="top" class="graysecheader" style="padding:5px;"><strong>Added  Date</strong></td>
				<td width="14%" align="left" valign="top" class="graysecheader" style="padding:5px;">File </td>
				<td width="8%" align="left" valign="top" class="graysecheader" style="padding:5px;">Status</td>
				<td width="7%" align="left" valign="top" class="graysecheader" style="padding:5px;">Action<span style="float:right; padding-right:5px;"><?php echo $totalRecords; ?> Items</span></td>
              </tr>
			...
			<?php
...

					{
						...
						$month_name='';
						$strurl='';
						while($rowVideos=mysql_fetch_array($resVideos))
						{
							$srNo++;
								...
								$getDate = strtotime($rowVideos["resourceDate"])
										

?>
						  <tr  <?php echo $strClass; ?>>
						    <td align="left" valign="top"><input name="chkdelete[]" type="checkbox" id="chkdelete<?php echo $counter; ?>" value="<?php echo trim($rowVideos["resourceId"]); ?>" class="deleteChk" /></td>
						    <td align="left" valign="top"><?php echo $rowVideos["resourceTitle"]; ?></td>
							<td align="left" valign="top"><?php echo $rowVideos["videoLink"]; ?></td>
							<td align="left" valign="top"><?php //echo date("F d,  Y", $getDate); ?><?php echo date("Y/m/d",$rowVideos["dateAdded"]); ?></td>
						    <td align="left" valign="top"><?php if ($rowVideos["resourceFile"]!=''){ ?><img src="../uploads/<?php echo trim($rowVideos['resourceFile']); ?>" height="100" width="100"><?php } ?> </td>
						    <td align="left" valign="top"><?php if($rowVideos["validYN"]=='N'){ ?><a href="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>?validYN=Y&_j=<?php echo md5("UPDATE"); ?>&txtParam1=<?php echo $rowVideos["resourceId"]; ?>" title="Inactive">Inactive</a><?php }else{?><a href="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>?validYN=N&_j=<?php echo md5("UPDATE"); ?>&txtParam1=<?php echo $rowVideos["resourceId"]; ?>" title="Active">Active</a><?php }?></td>
						    <td align="left" valign="top">
                              <table border="0" cellpadding="2" cellspacing="2">
							<tr>
							<td><a href="add-edit-videos.php?editid=<?php echo $rowVideos["resourceId"]; ?>"><img src="images/pencil.png" alt="Edit" width="16" height="16" title="Edit" border="0"></a></td>
							<td>&nbsp;</td>
                            <td><a href="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>?_b=<?php echo md5("ADMINCRC"); ?>&_j=<?php echo md5("DELETE"); ?>&txtParam1=<?php echo $rowVideos["resourceId"]; ?>&txtParam2=0&txtParam3=<?php echo $rowVideos["resourceFile2"]; ?>&txtParam4=<?php echo $rowVideos["resourceFile"]; ?>" onclick="javascript: return cmd_singledel();" title="Delete"><img src="images/cross.png" alt="Delete" width="16" height="16" border="0" /></a></td>
							</tr>
							</table>							</td>
						  </tr>
			<?php
  ...
  <tr>
	...
	<?php if($pageNo>1)
	{
		$prevPage=$pageNo-1;
	?>
		<a href="#"  onclick="javascript: document.Videos.txtPageNo.value='<?php echo $prevPage; ?>';document.Videos.submit();">&lt; previous</a>
	<?php
	}
	?>	</td>
	...
	<?php
		...
		for($pg=$page_min;$pg<= $page_max;$pg++)
		{
			if($pg==$pageNo)
				...
				$strPages.='<a href="#"  onclick="javascript: document.Videos.txtPageNo.value='.$pg.';document.Videos.submit();">'.$pg.'</a> | ';
		}
	...
	<?php if($pageNo>=1 && $pages>$pageNo)
	{
		$nextPage=$pageNo+1;
	?>
		<a href="#"  onclick="javascript: document.Videos.txtPageNo.value='<?php echo $nextPage; ?>';document.Videos.submit();">next &gt;</a>
	<?php
	}
	?>	</td>
  </tr>
